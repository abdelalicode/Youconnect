<div class="w-full max-w-sm overflow-hidden bg-white rounded-lg dark:bg-gray-800">
    <img class="object-cover object-center w-full h-48" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80" alt="avatar">
    ...
    <div class="px-4 py-2">
        <h1 class="text-lg font-semibold text-gray-800 dark:text-white">Patterson johnson</h1>

        <p class="py-1 text-sm text-gray-700 dark:text-gray-400">Full Stack maker & UI / UX Designer, love hip hop music Author of Building UI.</p>

        <div class="flex items-center mt-2 text-gray-700 dark:text-gray-200">
            <svg aria-label="suitcase icon" class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 class="px-2 text-xs">Meraki UI</h1>
        </div>
        ...
        <div class="flex items-center mt-1 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-xs">California</h1>
        </div>
