<div class="w-full max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-md dark:bg-gray-800 mb-5">
    ...
    <h2 class="mt-2 text-xl font-semibold text-gray-800 dark:text-white md:mt-0">JOE TRIBBIANI</h2>
    ...
    <div class="flex justify-end mt-4">
        <a href="#" class="text-lg font-medium text-blue-600 dark:text-blue-300" tabindex="0" role="link">+ Follow</a>
    </div>
</div>