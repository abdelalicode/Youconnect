...
<div id="dropdownNotification"
    ...
    <div class="block px-4 py-2 font-medium  text-gray-700 rounded-t-lg bg-gray-50 dark:bg-gray-800 dark:text-white">
        Notifications
    </div>
    <div class="divide-y divide-gray-100 dark:divide-gray-700">
        @if ($notifications->isEmpty())
            <div class="w-full p-3 ml-8">
                <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">No notification at the moment! enjoy
                    silence</div>
            </div>
        @endif
        @foreach ($notifications as $notification)
                ...
                <div class="flex-shrink-0">
                    ...
                    @else
                        <img class="rounded-full w-11 h-11"
                            src="https://cdn-icons-png.flaticon.com/512/2700/2700968.png" alt="Default Image">
                    @endif
                    <div
